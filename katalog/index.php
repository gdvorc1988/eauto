...
$arParam['PRICE_CODE'] = [];
if($arCurrentPrice['PRICE_CODE'] !== 'BASE')
{
    $arParam['PRICE_CODE'][] = $arCurrentPrice['PRICE_CODE'];
    $arParam['PRICE_CODE'][] = 'BASE';
}else{
    $arParam['PRICE_CODE'][] = $arCurrentPrice['PRICE_CODE'];
}
...
<?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"DETAIL_BLOG_USE" => "Y",
		"DETAIL_BRAND_PROP_CODE" => array("BREND","CML2_MANUFACTURER"),
		"DETAIL_BRAND_USE" => "Y",
		...
		"DETAIL_OFFERS_PROPERTY_CODE" => array("BREND", "NEW_PRODUCT", "DISCOUNTS", "CML2_ARTICLE"),
		"DETAIL_PRODUCT_INFO_BLOCK_ORDER" => "sku,props",
		"DETAIL_PRODUCT_PAY_BLOCK_ORDER" => "rating,price,priceRanges,quantityLimit,quantity,buttons",
		"DETAIL_PROPERTY_CODE" => array("SECHENIE","CML2_MANUFACTURER","BREND","CML2_ARTICLE"),
		...
		"LIST_PROPERTY_CODE" => array(0=>"NEW_PRODUCT",1=>"DISCOUNTS"),
		"LIST_SHOW_SLIDER" => "Y",
		...
		"SEF_FOLDER" => "/",
		"SEF_MODE" => "Y",
		"SEF_URL_TEMPLATES" => Array("compare"=>"compare/","element"=>"#SECTION_CODE_PATH#/#ELEMENT_CODE#/","section"=>"#SECTION_CODE_PATH#/","sections"=>"/katalog","smart_filter"=>"#SECTION_CODE_PATH#/filter/#SMART_FILTER_PATH#/apply/"),
		"SET_LAST_MODIFIED" => "N",
		"SET_STATUS_404" => "Y",
		"SET_TITLE" => "Y",
		"SHOW_404" => "N",
