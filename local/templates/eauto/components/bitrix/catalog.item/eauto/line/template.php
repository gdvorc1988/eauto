        ...
        <div class="product-item-image-slider-control-container" id="<?=$itemIds['PICT_SLIDER']?>_indicator"
            ...
            <?
					if ($showSlider)
					{
						...
						{
							?>
            <div class="product-item-image-slider-control<?=($key == 0 ? ' active' : '')?>" data-go-to="<?=$key?>">
            </div>
            <?
						}
					}
    ...
    <div class=" <?=$gridLastBlockClass; ?>">
        ...
        <div class="product-item-info-container product-item-price-container" data-entity="price-block">
            ...
            <?
							...
							{
								?>
            <br><span class="product-item-price-old" id="<?=$itemIds['PRICE_OLD']?>"
        ...
        <div class="product-item-info-container" data-entity="buttons-block">
            ...
            <div class="product-item-button-container">
                <?
										...
										?>
                <button class="btn btn-link <?=$buttonSizeClass?>" id="<?=$itemIds['NOT_AVAILABLE_MESS']?>"
                    href="javascript:void(0)" rel="nofollow">
