...
?>
<div class="show-filters-btn" id="js_show_filters">
	<svg class="icon-svg">
		<use xlink:href="#icon-filter" xmlns:xlink="http://www.w3.org/1999/xlink"></use>
    </svg>
</div>
<div class="bx_filter js-filter-show <?=$templateData["TEMPLATE_CLASS"]?>">
	<div class="bx_filter_ttl">Фильтры
		
		<div class="filter-result" id="modef" <?if(!isset($arResult["ELEMENT_COUNT"])) echo 'style="display:none"';?> style="display: inline-block;">
		<span id="modef_num"><?=intval($arResult["ELEMENT_COUNT"]);?></span>
		<!--<span class="arrow"></span>
		<a href="<?echo $arResult["FILTER_URL"]?>"><?echo GetMessage("CT_BCSF_FILTER_SHOW")?></a>-->
		</div>
		<?if (SITE_TYPE == 'pda'){?>
			<!-- <input type="button" name="close-filter" class="bx_filter-close-btn js-close-filter" value="x"> -->
	...
	<?if (isset($arResult["ITEMS"]) && count($arResult["ITEMS"])>0){?>
		<form name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get" class="smartfilter">
			...
			<div class="bx_filter_param_box">
			<div class="bx_filter_scrollable_area">
			...
			<div class="bx_filter_button_box active">
				<div class="bx_filter_block">
					<div class="bx_filter_parameters_box_container">
						<input class="btn btn_red mobile-filter-submit" type="submit" id="set_filter" name="set_filter" value="<?=GetMessage("CT_BCSF_SET_FILTER")?>" />
						<?if (SITE_TYPE == 'pda'){?>
							<input class="bx_filter_search_reset js-clear-filter" type="button" name="clear_filter" value="<?=GetMessage("CT_BCSF_DEL_FILTER")?>" />
						<?} else {?>
