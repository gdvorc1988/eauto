...
$arResult['SEO_DESCRIPTION'] = $arResult["IPROPERTY_VALUES"]["ELEMENT_META_DESCRIPTION"];
$arResult['SEO_TITLE'] = $arResult["IPROPERTY_VALUES"]["ELEMENT_META_TITLE"];

$cp = $this->__component;

if(is_object($cp))
    $cp->SetResultCacheKeys(['SEO_DESCRIPTION','SEO_TITLE']);
