...
<!--                            {{QUANTITY}} {{MEASURE_TEXT}}-->
                                <input type="text" class="basket-item-amount-filed input-number__input js-prod-count-inp" value="{{QUANTITY}}"
                                       {{#NOT_AVAILABLE}} disabled="disabled"{{/NOT_AVAILABLE}}
                                data-value="{{QUANTITY}}" data-entity="basket-item-quantity-field"
                                id="basket-item-quantity-{{ID}}">
                                <div class="input-number__add js-amount-plusbasket-item-amount-btn-plus" data-entity="basket-item-quantity-plus"></div>
                                <div class="input-number__sub js-amount-minusbasket-item-amount-btn-minus" data-entity="basket-item-quantity-minus"></div>
...
<?/*
			...
			?>
			<td class="basket-item-actions-remove" data-entity="basket-item-delete">
