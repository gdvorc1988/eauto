...
$APPLICATION->AddHeadString('<script type="text/javascript">var basketJSParams = '.CUtil::PhpToJSObject($arBasketJSParams).'</script>', true);
...
if (empty($arResult['ERROR_MESSAGE']))
{
	...
	?>
	<div id="basket-root" class="content-sidebar" style="opacity: 0;">
		<?/*
		...
		<?//<div class="content-sidebar__content">?>
			<div class="block full-wide">
				...
				<div data-entity="basket-total-block" class="basket-total-block"></div>
			</div>
		<?//</div>?>
		<?
		if (
