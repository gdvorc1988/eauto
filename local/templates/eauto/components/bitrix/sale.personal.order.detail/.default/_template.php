				...
				<div class="sale-order-detail-card">
					...
					<div>
						<div>
							...
							<div class="sale-order-detail-more-info-details" style="display: none;">
								<div>
									<h4 class="sale-order-detail-more-info-details-title"><?= Loc::getMessage('SPOD_USER_INFORMATION') ?></h4>

									<div class="table-responsive">
										<table class="table table-bordered table-striped sale-order-detail-more-info-details-table">
										...
										if (isset($arResult["ORDER_PROPS"]))
										{
											foreach ($arResult["ORDER_PROPS"] as $property)
											{
												?>
												<tr>
													<th><?= htmlspecialcharsbx($property['ID']) ?>:</th>
					...
					<? if (strlen($arResult["USER_DESCRIPTION"]))
					{
						...
						<div>
							<div>
								...
								<p class="sale-order-detail-section-comments"><?=nl2br(htmlspecialcharsbx($arResult["USER_DESCRIPTION"]))?></p>
							</div>
						</div>
						<?
					}
					...
					<div>
						<div>
							...
							<div class="align-items-center">
								<div class="sale-order-detail-section-payment-image"></div>
								<div>
									...
									<div class="sale-order-detail-payment-options-methods-container">
										<div class="payment-options-methods-row">
											<div class="sale-order-detail-payment-options-methods">
												<div class="align-items-center sale-order-detail-payment-options-methods-information-block">
										...
										<div class="sale-order-detail-payment-options-shipment">
											<div class="row">
												...
												<div class="sale-order-detail-payment-options-methods-shipment-list">
													...
													{
														?>
														<div class="sale-order-detail-payment-options-methods-shipment-list-item"><?= Loc::getMessage('SPOD_ORDER_DELIVERY')?>: <?= htmlspecialcharsbx($shipment["DELIVERY_NAME"])?></div>
														<?
													}
													?>
													...
													<div class="mt-3 sale-order-detail-payment-options-methods-shipment-list-item-link">
															...
															<div class="row">
																<div class="sale-order-detail-payment-options-shipment-map-address">
																	<div class="row">
																		...
																		<span class="sale-order-detail-payment-options-shipment-map-address-element"> <?= htmlspecialcharsbx($store['ADDRESS'])?> </span>
																	</div>
																</div>
															</div>
															<?
